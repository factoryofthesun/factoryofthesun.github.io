...
function main() {
    ...
    if (elem.dataset.anchorx && elem.dataset.anchory && elem.dataset.anchorz) {
        camera.lookAt(new THREE.Vector3(elem.dataset.anchorx,elem.dataset.anchory,elem.dataset.anchorz));   
    } else {
        camera.lookAt(new THREE.Vector3(0,0,0));
    }
    if (elem.dataset.camerax && elem.dataset.cameray && elem.dataset.cameraz) {
    ...
    function sceneInitFunction(elem) {
        ...
        var topLight = new THREE.DirectionalLight(new THREE.Color('rgb(255, 255, 255)'), 1.0);
        keyLight.position.set(50, 100, 50);

        var botLight = new THREE.DirectionalLight(new THREE.Color('rgb(255, 255, 255)'), 1.0);
        keyLight.position.set(-50, -100, -50);
        ...
        const nonselectionobj = elem.dataset.nonselectionobj
        ...
        const x = elem.dataset.anchorx
        const y = elem.dataset.anchory
        const z = elem.dataset.anchorz
